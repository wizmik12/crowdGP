...
class SVGPLatent(LatentFunction):
    ...
    def expected_log_p_z(self, X: tf.Tensor) -> tf.Tensor:
        """See :meth:`~gpcrowd.latent.base.LatentFunction.expected_log_p_z`.
    ...
    def prior_kl(self) -> tf.Tensor:
        """See :meth:`~gpcrowd.latent.base.LatentFunction.prior_kl`.
    ...
    def predict_class_probs(self, X: tf.Tensor) -> tf.Tensor:
        """See :meth:`~gpcrowd.latent.base.LatentFunction.predict_class_probs`.
